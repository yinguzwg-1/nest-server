import { Controller, Post, Body, HttpStatus, HttpCode, ValidationPipe, UsePipes, Logger } from '@nestjs/common';
...
export class TrackerController {
  ...
  async trackBatchEvents(@Body() eventsDto: TrackerEventDto[]): Promise<ITrackerEventResponse> {
    try {
