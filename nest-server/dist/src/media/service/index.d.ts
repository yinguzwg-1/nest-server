...
export declare class MediaService {
    ...
    findOneWithTranslationsRaw(id: number): Promise<MediaWithTranslations>;
    findAllWithTranslationsRaw(query: QueryMediaDto): Promise<MediaWithTranslationsResponseDto>;
}
